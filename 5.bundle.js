 ...
 * limitations under the License.
 */
function C(t,e){return new Promise((function(i,r){var s=Math.max(e-Date.now(),0),n=setTimeout(i,s);t.addEventListener((function(){clearTimeout(n),r(f.create("fetch-throttle",{throttleEndTimeMillis:e}))}))}))}var T=function(){function t(t,e){this.client=t,this.storage=e}return t.prototype.fetch=function(t){return s.__awaiter(this,void 0,void 0,(function(){var e;return s.__generator(this,(function(i){switch(i.label){case 0:return[4,this.storage.getThrottleMetadata()];case 1:return e=i.sent()||{backoffCount:0,throttleEndTimeMillis:Date.now()},[2,this.attemptFetch(t,e)]}}))}))},t.prototype.attemptFetch=function(t,e){var i=e.throttleEndTimeMillis,r=e.backoffCount;return s.__awaiter(this,void 0,void 0,(function(){var e,o,a;return s.__generator(this,(function(s){switch(s.label){case 0:return[4,C(t.signal,i)];case 1:s.sent(),s.label=2;case 2:return s.trys.push([2,5,,7]),[4,this.client.fetch(t)];case 3:return e=s.sent(),[4,this.storage.deleteThrottleMetadata()];case 4:return s.sent(),[2,e];case 5:if(!function(t){if(!(t instanceof n.FirebaseError))return!1;var e=Number(t.httpStatus);return 429===e||500===e||503===e||504===e}(o=s.sent()))throw o;return a={throttleEndTimeMillis:Date.now()+n.calculateBackoffMillis(r),backoffCount:r+1},[4,this.storage.setThrottleMetadata(a)];case 6:return s.sent(),[2,this.attemptFetch(t,a)];case 7:return[2]}}))}))},t}(),S="@firebase/remote-config";
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
function E(t){t.INTERNAL.registerComponent(new a.Component("remoteConfig",(function(e,i){var r=e.getProvider("app").getImmediate(),s=e.getProvider("installations").getImmediate();if("undefined"==typeof window)throw f.create("registration-window");var n=r.options,a=n.projectId,c=n.apiKey,u=n.appId;if(!a)throw f.create("registration-project-id");if(!c)throw f.create("registration-api-key");if(!u)throw f.create("registration-app-id");i=i||"firebase";var h=new y(u,r.name,i),g=new b(h),d=new o.Logger(S);d.logLevel=o.LogLevel.ERROR;var m=new p(s,t.SDK_VERSION,i,a,c,u),_=new T(m,h),w=new l(_,h,g,d),C=new v(r,w,g,h,d);return C.ensureInitialized(),C}),"PUBLIC").setMultipleInstances(!0)),t.registerVersion(S,"0.1.28")}E(h.default),e.registerRemoteConfig=E},83:function(t,e,i){"use strict";i.r(e);i(79)}}]);